...
public:
	 ...
	 * @param  dValue   フリッパーの角度
	 * @return なし
	 */
	void SetFrontRightAngle(const double dValue);
	 ...
	 * @return なし
	 */
	void SetFrontLeftAngle(const double dValue);
	 ...
	 * @return なし
	 */
	void SetBackRightAngle(const double dValue);
	 ...
	 * @return なし
	 */
	void SetBackLeftAngle(const double dValue);
